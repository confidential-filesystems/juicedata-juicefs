...
#Bucket=jfs_${FsId}
Bucket=jfstest
# S3 supports two styles of endpoint URI: virtual hosted-style and path-style
ObjStoreBucket=http://10.11.35.45:9000/${Bucket}
KeyId=aZQqo4FEU1HERJqtp0Xt
KeySecret=sjXuEmKicDXS6k0UnbqFb0bPiwzeGrx4NHc0jXsd
...
# encrypt algorithm (aes256gcm-aesgcm, aes256gcm-rsa, chacha20-rsa) (default: "aes256gcm-aesgcm")
# --session-token
...
#
echo "" && echo "" && echo ""
echo "create s3 fs (FsId=${FsId}, ObjStoreBucket=${ObjStoreBucket}, VolumeName=${VolumeName}) over."
echo "" && echo "" && echo ""
exit 0
#end
